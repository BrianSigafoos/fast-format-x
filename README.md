...
If `.fast-format-x.yaml` doesn't exist, `ffx init` also creates a template with common formatters and a reminder to customize the tools for your repository. Update or remove the sample tools before running `ffx`.
